    ...
    return <div className = "everything">
      ...
      <main className = "mainbody">
          ...
          <div className = "sidedisplay bg-transparent">
              ...
              {
                section === 'settings' && (
                  <div className="sub-flex w-full items-center justify-between gap-4">
                    ...
                    <input type = "file" className ="bg-teal-500 hidden" id="guideButton" onChange={(event) => uploadHandler(event)} />
                      <label htmlFor="guideButton" className="uploadB bg-teal-100 rounded-md px-10 py-2">Upload</label>
