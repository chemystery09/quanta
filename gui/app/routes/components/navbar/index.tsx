...
export default function Navbar({ isTopOfPage, selectedPage,setSelectedPage }: Props) {
  ...
  const navbarBackground = isTopOfPage ? "" : "bg-purple-100 drop-shadow"
    return <nav>
        <div
            ...
            <div className={`${flexBetween} mx-auto w-5/6`}>
                <div className = {`${flexBetween} w-full gap-16`}>
                    ...
                    {isAboveMediumScreens ? (
                        ...
                        <button className="rounded-full bg-purple-300 p-2"
        ...
        {!isAboveMediumScreens && isMenuToggled && (
            <div className="fixed right-0 bottom-0 z-40 h-full bg-purple-300 w-[300px] drop-shadow-xl">
