...
const ProjectFeature = ({name,description,image}: Props) => {
  const overlayStyles = `p-5 absolute z-30 flex h-[380px] w-[450px] flex-col items-center justify-center
  whitespace-normal bg-teal-500 text-center text-white opacity-0 transition duration-500 hover:opacity-90`;
