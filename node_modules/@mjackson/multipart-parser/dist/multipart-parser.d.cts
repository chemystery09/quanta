 ...
 */
declare function parseMultipart(message: MultipartMessageSource, options: ParseMultipartOptions, handler: MultipartPartHandler): Promise<void>;
 ...
 */
declare function isMultipartRequest(request: Request): boolean;
/**
 ...
 */
declare function parseMultipartRequest(request: Request, handler: MultipartPartHandler): Promise<void>;
declare function parseMultipartRequest(request: Request, options: MultipartParserOptions, handler: MultipartPartHandler): Promise<void>;
